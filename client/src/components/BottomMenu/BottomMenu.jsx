  ...
  return (
    counter > 0 && (
      <div className="hidden sm:flex absolute bottom-10 left-1/2 lg:left-[70%] -translate-x-1/2 lg:-translate-x-3/4  items-center gap-x-2 bg-white rounded-xl p-2 shadow-xl z-[100]">
        ...
        <div className="font-menagrotesk-semi bg-white font-medium rounded-xl text-sm px-3 py-2 text-center hover:bg-[#d3d3d4] flex gap-x-1  items-center cursor-pointer border-[1px] border-[#d3d3d4] shadow-lg">
          <HiOutlineArchiveBox size={18} />
          <h1>Archive</h1>
        </div>
        <div className="font-menagrotesk-semi text-red-600 bg-white font-medium rounded-xl text-sm px-3 py-2 text-center hover:bg-[#d3d3d4] flex gap-x-1  items-center cursor-pointer border-[1px] border-[#d3d3d4] shadow-lg">
